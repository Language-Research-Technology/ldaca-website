...
If you are someone who makes decisions about a collection of language materials, you are a [data steward](https://www.ldaca.edu.au/resources/glossary/#data-steward). Read on to find out how RO-Crate data packaging could help your collection, and why the Language Data Commons of Australia use RO-Crates in their infrastructure.

## What is an RO-Crate?

Research Object Crate (RO-Crate) is a way of packaging data – like audio recordings, photographs, manuscripts or teaching materials – together with its metadata. Metadata tells us information about the data, like who created it, when, and in which languages. 
<br></br>
...
RO-Crates are used by 2 groups:
<br>
