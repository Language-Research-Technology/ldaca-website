...
<img src='Slide00.png' alt='Crate-O - a drop-in linked data metadata editor for RO-Crate (and other) linked data in repositories and beyond ::  :: ' title='Slide: 0' border='1'  width='85%%'/>
...
<section typeof='http://purl.org/ontology/bibo/Slide'>
<img src='Slide01.png' alt=' ::  :: ' title='Slide: 1' border='1'  width='85%%'/>
...
<section typeof='http://purl.org/ontology/bibo/Slide'>
<img src='Slide02.png' alt='Five ways RO-Crate data packages are important for repositories :: Peter Sefton*, Stian Soiland-Reyes** ::  :: *University of Queensland, Australia; **The University of Manchester, UK ::  ::  :: Time: 05/June/2024: 11:00 - 12:30 · Location: Drottningporten 1 :: ' title='Slide: 2' border='1'  width='85%%'/>



I am presenting in the next session on why RO-Crate is important for repositories - which is too late for this session, but if you’re a developer then maybe that will be of interest.
...
<section typeof='http://purl.org/ontology/bibo/Slide'>
<img src='Slide04.png' alt=' :: Start describing your research  :: TODAY! :: ' title='Slide: 4' border='1'  width='85%%'/>
...
The CrateEditor component is exported as ES Module and can be imported into any Vue web app by adding Crate-O as dependency.
...
<section typeof='http://purl.org/ontology/bibo/Slide'>
<img src='Slide08.png' alt='Embed Crate-O in your own Vue app ::  :: ' title='Slide: 8' border='1'  width='85%%'/>



This illustrates the very basic example of embedding Crate-O CrateEditor in any Vue app
...
<img src='Slide11.png' alt='Find this presentation online at: ::  :: https://www.ldaca.edu.au/news/posts/open-repositories-2024-crate-o  :: ' title='Slide: 11' border='1'  width='85%%'/>
