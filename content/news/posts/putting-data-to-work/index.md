...
{{< image Src="/putting-data-to-work/Barry_Humphries.jpg" Alt="Barry Humphries" Desc="Figure 4: Barry Humphries." Title="Barry Humphries" Ref="Wikimedia">}}
...
I referred to another dataset from LDaCA in discussing the relative absence of Indigenous Australians from the language I was investigating. _The Betoota Advocate_ purports to represent the opinions and world view of a rural community in the Channel Country of western Queensland. To highlight how Indigenous peoples were represented in _Betootaisms_, I was able to make a comparison with the oral history material from the same location in the [_Braided Channels_](https://data.ldaca.edu.au/collection?id=arcp%3A%2F%2Fname%2Chdl10.4225~01~4F8E1281B8E2A&_crateId=arcp%3A%2F%2Fname%2Chdl10.4225~01~4F8E1281B8E2A) collection (also listed in LDaCA).
