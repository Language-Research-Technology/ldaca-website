...
My article on [_Australian Slang as a literary genre_](https://www.tandfonline.com/eprint/7TTMIQFAVG8VKYJSTQWY/full?target=10.1080/07268602.2024.2444219) has recently been published by the [Australian Journal of Linguistics](https://www.tandfonline.com/journals/cajl20) and four datasets from the Language Data Commons of Australia (LDaCA) collection are cited there. Although the results derived from that data are covered in a few sentences (in an 8,000 word piece), access to the data was crucial in making a strong argument. This post is intended to show how that was the case, and therefore, why infrastructure such as LDaCA is valuable to researchers.
...
I also referred to another dataset from LDaCA in discussing the relative absence of Indigenous Australians from the language I was investigating. _The Betoota Advocate_ purports to represent the opinions and world view of a rural community in the Channel Country of western Queensland. To highlight how Indigenous peoples were represented in _Betootaisms_, I was able to make a comparison with the oral history material from the same location in the [_Braided Channels_](https://data.ldaca.edu.au/collection?id=arcp%3A%2F%2Fname%2Chdl10.4225~01~4F8E1281B8E2A&_crateId=arcp%3A%2F%2Fname%2Chdl10.4225~01~4F8E1281B8E2A) collection (also listed in LDaCA).
