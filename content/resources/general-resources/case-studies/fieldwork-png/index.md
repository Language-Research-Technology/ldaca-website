...
It's often suggested that the researcher should make a will and assign a literary executor for the data they collect. This raises the question about who to nominate? As a graduate student, I nominated one of my supervisors as the person to have direct access and editing powers over the archived corpus.
This makes sense in that, after myself, my supervisor is one of the people who knows the most about the project and {{< glossary_link display="data collection" id="data-collection" >}}. Supervisors are also often the chief investigator for ethics approval for graduate {{< glossary_link display="data collection" id="data-collection" >}} as well. But supervisors tend to be older than graduate students and don’t necessarily have any personal connection to the speaker community.
