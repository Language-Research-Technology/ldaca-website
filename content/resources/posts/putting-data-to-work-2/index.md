...
draft: false
description: "Learn more about the challenges of working with an unwieldy data source — the Australian Federal Hansard — from Simon Musgrave. In the blog post, Simon unpacks approaches to issues of access and scale allowing for the effective use of this data source."
layout: post
author: '<Profile id="musgrave" />'
image: "/resources/posts/putting-data-to-work-2/hansard.jpeg"
---
