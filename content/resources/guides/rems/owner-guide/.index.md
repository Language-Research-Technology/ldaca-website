...
The LDaCA <GlossaryLink display="REMS" id="rems" /> system administrator assigns the Resource Owner role to <GlossaryLink display="data stewards" id="data-steward" /> or their designated persons.
...
<figure>
  <img src="/resources/guides/rems/AdministrationMenu-Organization.png" Alt="REMS: Administration Sub-Menu" Title="REMS: Administration Sub-Menu" Ref="LDaCA" />
  <figcaption>REMS: Administration Sub-Menu</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/CreateOrganization.png" Alt="REMS: Create Organization" Title="REMS: Create Organization" Ref="LDaCA" />
  <figcaption>REMS: Create Organization</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/REMS-Orgs-Failed-IDAlreadyInUse.png" Alt="REMS: Organization ID Already in Use" Title="REMS: Organization ID Already in Use" Ref="LDaCA" />
  <figcaption>REMS: Organization ID Already in Use</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/Organization-DisableArchive.png" Alt="REMS: Organization Disable and Archive Buttons" Title="REMS: Organization Disable and Archive Buttons" Ref="LDaCA" />
  <figcaption>REMS: Organization Disable and Archive Buttons</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/Organization-Disable-Enable.png" Alt="REMS: Organization Disable and Enable Buttons" Title="REMS: Organization Disable and Enable Buttons" Ref="LDaCA" />
  <figcaption>REMS: Organization Disable and Enable Buttons</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/Organizations-ArchiveUnarchive.png" Alt="REMS: Organization Archive and Unarchive Buttons" Title="REMS: Organization Archive and Unarchive Buttons" Ref="LDaCA" />
  <figcaption>REMS: Organization Archive and Unarchive Buttons</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/CreateLicense.png" Alt="REMS: Create License" Title="REMS: Create License" Ref="LDaCA" />
  <figcaption>REMS: Create License</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/REMS-NoForm.png" Alt="REMS: No Form" Title="REMS: No Form" Ref="LDaCA" />
  <figcaption>REMS: No Form</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/REMS-DefaultApplicationForm.png" Alt="REMS: Default License Application Form" Title="REMS: Default License Application Form" Ref="LDaCA" />
  <figcaption>REMS: Default License Application Form</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/REMS-SubmitApplication.png" Alt="REMS: Workflow for Default License Application Form" Title="REMS: Workflow for Default License Application Form" Ref="LDaCA" />
  <figcaption>REMS: Workflow for Default License Application Form</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/REMS-ReuseExistingForm.png" Alt="REMS: Reuse an Existing Form" Title="REMS: Reuse an Existing Form" Ref="LDaCA" />
  <figcaption>REMS: Reuse an Existing Form</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/REMS-CreateForm.png" Alt="REMS: Create Form" Title="REMS: Create Form" Ref="LDaCA" />
  <figcaption>REMS: Create Form</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/Forms-AppTitleFieldBox.png" Alt="REMS: Field 1 Example Form" Title="REMS: Field 1 Example Form" Ref="LDaCA" />
  <figcaption>REMS: Field 1 Example Form</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/PreviewAttachments.png" Alt="REMS: Form Attachment Preview" Title="REMS: Form Attachment Preview" Ref="LDaCA" />
  <figcaption>REMS: Form Attachment Preview</figcaption>
</figure>
...
LDaCA REMS manages <GlossaryLink display="data license" id="data-license" /> entitlement, hence the resources are the licenses.

> Linking the license to data <GlossaryLink display="objects" id="object" /> is done in the backend for Resource Owners by LDaCA.
...
<figure>
<img src="/resources/guides/rems/REMS-CreateResource.png" Alt="REMS: Create Resource" Title="REMS: Create Resource" Ref="LDaCA" />
<figcaption>REMS: Create Resource</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/RevokeEntitlement.png" Alt="REMS: Revoke Entitlement" Title="REMS: Revoke Entitlement" Ref="LDaCA" />
  <figcaption>REMS: Revoke Entitlement</figcaption>
</figure>
...
The Resource Owner must create a workflow for their resource (i.e. the <GlossaryLink display="data license" id="data-license" />). In a workflow, the Owner must assign Handlers and connect the workflow to a form and license.
...
<figure>
  <img src="/resources/guides/rems/REMS-CreateWorkflow.png" Alt="REMS: Create Workflow" Title="REMS: Create Workflow" Ref="LDaCA" />
  <figcaption>REMS: Create Workflow</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/Admin-CatalogueItems.png" Alt="REMS: Catalogue Items" Title="REMS: Catalogue Items" Ref="LDaCA" />
  <figcaption>REMS: Catalogue Items</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/REMS-CreateCatalogueItem.png" Alt="REMS: Create Catalogue Item" Title="REMS: Create Catalogue Item" Ref="LDaCA" />
  <figcaption>REMS: Create Catalogue Item</figcaption>
</figure>
