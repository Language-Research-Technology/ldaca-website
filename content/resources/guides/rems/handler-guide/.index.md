...
> For each role you have in LDaCA <GlossaryLink display="REMS" id="rems" />, log in with a consistent identity provider as all your actions are connected to your login identity.
...
<figure>
  <img src="/resources/guides/rems/REMS-NewLicenseApplicationEmail.png" Alt="REMS: New License Application Email" Title="REMS: New License Application Email" Ref="LDaCA" />
  <figcaption>REMS: New License Application Email</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/Handler-CheckEvents.png" Alt="REMS: Application Record with Events History" Title="REMS: Application Record with Events History" Ref="LDaCA" />
  <figcaption>REMS: Application Record with Events History</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/Handler-AllActions.png" Alt="REMS: Application Form Actions" Title="REMS: Application Form Actions" Ref="LDaCA" />
  <figcaption>REMS: Application Form Actions</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/Handler-ApproveOrRejectWindow.png" Alt="REMS: Approve or Reject Application" Title="REMS: Approve or Reject Application" Ref="LDaCA" />
  <figcaption>REMS: Approve or Reject Application</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/Handler-ReturnToApplicant.png" Alt="REMS: Return Application to Applicant" Title="REMS: Return Application to Applicant" Ref="LDaCA" />
  <figcaption>REMS: Return Application to Applicant</figcaption>
</figure>
...
- Select this to notify the designated Reviewer (e.g. the organisation Owner in LDaCA REMS, who may also be the <GlossaryLink display="data steward" id="data-steward" />) that the application needs to be reviewed.

<figure>
  <img src="/resources/guides/rems/Handler-RequestReview.png" Alt="REMS: Application Request Review" Title="REMS: Application Request Review" Ref="LDaCA" />
  <figcaption>REMS: Application Request Review</figcaption>
</figure>

<br>

<figure>
  <img src="/resources/guides/rems/Handler-RequestReviewOptions.png" Alt="REMS: Application Request Review Previews" Title="REMS: Application Request Review Previews" Ref="LDaCA" />
  <figcaption>REMS: Application Request Review Previews</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/Handler-RequestDecision.png" Alt="REMS: Application Request Decision" Title="REMS: Application Request Decision" Ref="LDaCA" />
  <figcaption>REMS: Application Request Decision</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/Handler-Remark.png" Alt="REMS: Application Remark" Title="REMS: Application Remark" Ref="LDaCA" />
  <figcaption>REMS: Application Remark</figcaption>
</figure>
...
<figure>
  <img src="/resources/guides/rems/Handler-CloseApplication.png" Alt="REMS: Close Application" Title="REMS: Close Application" Ref="LDaCA" />
  <figcaption>REMS: Close Application</figcaption>
</figure>
