...
| **Applicant** | A user who applies for entitlement to a resource, i.e. <GlossaryLink display="data license" id="data-license" />, by submitting an application form.                                                                                                                                                                                                                    |
...
<figure>
    <img src="/resources/guides/rems/Owner-TopMenu.png" Alt="REMS Owner: Top Menu" Title="REMS Owner: Top Menu" Ref="LDaCA" />
    <figcaption>REMS Owner: Top Menu</figcaption>
</figure>
...
<figure>
    <img src="/resources/guides/rems/Owner-NotHandler-TopMenu.png" Alt="REMS Owner: Top Menu without Handler Permissions" Title="REMS Owner: Top Menu without Handler Permissions" Ref="LDaCA" />
    <figcaption>REMS Owner: Top Menu without Handler Permissions</figcaption>
</figure>
...
<figure>
    <img src="/resources/guides/rems/REMS-Interface-Catalogue.png" Alt="REMS Interface: Catalogue" Title="REMS Interface: Catalogue" Ref="LDaCA" />
    <figcaption>REMS Interface: Catalogue</figcaption>
</figure>
...
<figure>
    <img src="/resources/guides/rems/REMS-Interface-Applications.png" Alt="REMS Interface: Applications" Title="REMS Interface: Applications" Ref="LDaCA" />
    <figcaption>REMS Interface: Applications</figcaption>
</figure>
...
<figure>
    <img src="/resources/guides/rems/REMS-Interface-Actions.png" Alt="REMS Interface: Actions" Title="REMS Interface: Actions" Ref="LDaCA" />
    <figcaption>REMS Interface: Actions</figcaption>
</figure>
...
<figure>
    <img src="/resources/guides/rems/REMS-Interface-Administration.png" Alt="REMS Interface: Administration" Title="REMS Interface: Administration" Ref="LDaCA" />
    <figcaption>REMS Interface: Administration</figcaption>
</figure>
...
About displays basic information about LDaCA <GlossaryLink display="REMS" id="rems" />.

<figure>
    <img src="/resources/guides/rems/REMS-Interface-About.png" Alt="REMS Interface: About" Title="REMS Interface: About" Ref="LDaCA" />
    <figcaption>REMS Interface: About</figcaption>
</figure>
