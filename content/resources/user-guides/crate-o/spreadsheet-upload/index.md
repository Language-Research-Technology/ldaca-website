...
| -------------------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| @id                  | Data entry | Persistent, managed unique ID in URL format (if available), for example, a {{< glossary_link display="DOI" id="doi" >}} for a collection. The default for this field is `./` indicating a relative path to your current directory, however if you use a persistent ID in this field, ensure you first edit the `@id` field in {{< glossary_link display="Crate-O" id="crate-o" >}} with the same value before loading your spreadsheet so that the related metadata is correctly mapped. |
