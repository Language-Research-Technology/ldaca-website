...
{{< glossary_link display="Access conditions" id="access-conditions" >}} for data in LDaCA are determined by the Data Steward. To assist with this, LDaCA provides: information to help Data Stewards make informed decisions about appropriate {{< glossary_link display="access conditions" id="access-conditions" >}} for the data; tools and resources to facilitate this process as collections are onboarded and made available (including for applying standards as required); and mechanisms for managing these once data is onboarded.
