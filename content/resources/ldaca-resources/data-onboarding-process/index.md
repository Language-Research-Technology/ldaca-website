...
draft: false
description: "Outlines the standards and processes that support the preparation of PILARS compliant data collections."
---
...
- [4. Preparing data for cataloguing](#4-preparing-data-for-cataloguing)
- [5. Publishing](#5-publishing)
- [6. Ongoing engagement](#6-ongoing-engagement)
...
The LDaCA onboarding process is carried out collaboratively between LDaCA and the {{< glossary_link display="Data Steward" id="data-steward" >}}. There are six broad steps to be followed; while the order of these steps is flexible, each step should be appropriately covered.
...
{{< glossary_link display="Data Stewards" id="data-steward" >}} wishing to onboard data may approach LDaCA about this, and LDaCA will also seek to identify appropriate collections for onboarding.
...
5. Discuss needs and goals for onboarding.
...
If the collection is to be published using LDaCA infrastructure (e.g. an Oni or static site), the following steps will apply.

1. Check the collection metadata is comprehensive and conforms to RO-Crate standards.
2. Check the data formats and provide guidance where needed to format data for the infrastructure.
3. Publish required licences in public URLs.
4. If needed, prepare the data for checking in a private portal.
5. When approved, make final changes and publish.
...
2. If published on the LDaCA portal, make the {{< glossary_link display="Data Steward" id="data-steward" >}} aware of any takedown requests.
...
2. If published on the LDaCA portal, review any takedown requests, make a decision about how to address them, and inform LDaCA of that decision.
3. Update the {{< glossary_link display="Work Plan" id="work-plan" >}} as relevant, with responsibilities for ongoing maintenance of the collection in LDaCA.
