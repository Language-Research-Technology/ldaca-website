  ...
  <div class="slide">
    ...
    <div>
      <div class="slide__content">
        ...
        <h4></h4>
        <ul>
        <h3><li>Case Study: Data Management in Language Technology (<a href = "./resources/general-resources/case-studies/data-mangement-appen/" target="_blank">Read more ➤</a>)</li></h3>
