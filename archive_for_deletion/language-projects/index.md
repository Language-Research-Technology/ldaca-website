...
Provides information about the languages of the world, but operates on a subscription model. The information that is available without a subscription is very limited: the first three lines of individual language entries which include the [ISO 639-3](/resources/guides/metadata/#iso-639) code, the classification of the language into a language family, and a link to the language’s <GlossaryLink display="OLAC" id="olac" /> page.

<br>

### [Glottolog](https://glottolog.org/)

Comprehensive reference information for the world's languages, especially the lesser-known languages. <GlossaryLink display="LDaCA" id="ldaca" /> uses <GlossaryLink display="Glottolog" id="glottolog" /> [language codes](/resources/guides/metadata/#glottolog) in our <GlossaryLink display="metadata" id="metadata" />.
...
<GlossaryLink display="OLAC" id="olac" /> harvests metadata and their website has a search facility to find resources for languages. <GlossaryLink display="OLAC" id="olac" /> [metadata recommendations](/resources/guides/metadata/#olac) are the basis for some of LDaCA's metadata.
