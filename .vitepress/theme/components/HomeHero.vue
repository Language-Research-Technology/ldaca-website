...
<template>
  ...
  <section class="w-full" :style="{ backgroundColor: headerBgColor }">

    <!-- DESKTOP / LARGE SCREEN -->
    <div
      class="hidden xl:flex mx-auto px-40 py-16 items-center gap-12"
      :style="{
  ...
  >
    ...
    <div class="relative z-10 w-20 h-20 bg-[#79a38d] rounded-full flex items-center justify-center shadow-lg hover:bg-[#8faf9b]">
  ...
  ></iframe>
    ...
    <div class="xl:hidden mx-auto px-6 py-12 space-y-8">
      <div v-for="(item, index) in [{ tagline, description, videoUrl }]" :key="index" class="bg-gray-800 rounded-lg p-6 shadow-sm">
        ...
        <iframe
          ...
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          allowfullscreen
          class="w-full aspect-[16/9] rounded"
        ></iframe>
      </div>
    </div>
